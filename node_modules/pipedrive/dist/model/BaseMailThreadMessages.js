...
var _BaseMailThreadMessagesAllOf = _interopRequireDefault(require("./BaseMailThreadMessagesAllOf"));
 ...
 * @version 1.0.0
 */
var BaseMailThreadMessages = /*#__PURE__*/function () {
  /**
   ...
   */
  function BaseMailThreadMessages() {
    (0, _classCallCheck2["default"])(this, BaseMailThreadMessages);
    _CommonMailThread["default"].initialize(this);
    _BaseMailThreadMessagesAllOf["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(BaseMailThreadMessages, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _BaseMailThreadMessagesAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('cc')) {
          obj['cc'] = _ApiClient["default"].convertToType(data['cc'], [_MailThreadParticipant["default"]]);
          delete data['cc'];
        }
        if (data.hasOwnProperty('bcc')) {
          obj['bcc'] = _ApiClient["default"].convertToType(data['bcc'], [_MailThreadParticipant["default"]]);
          delete data['bcc'];
        }
 ...
 * @member {Array.<module:model/MailThreadParticipant>} from
 */
_BaseMailThreadMessagesAllOf["default"].prototype['from'] = undefined;
/**
 * Recipients of the mail thread
 * @member {Array.<module:model/MailThreadParticipant>} to
 */
_BaseMailThreadMessagesAllOf["default"].prototype['to'] = undefined;
/**
 * Participants of the Cc
 * @member {Array.<module:model/MailThreadParticipant>} cc
 */
_BaseMailThreadMessagesAllOf["default"].prototype['cc'] = undefined;
/**
 * Participants of the Bcc
 * @member {Array.<module:model/MailThreadParticipant>} bcc
 */
_BaseMailThreadMessagesAllOf["default"].prototype['bcc'] = undefined;
/**
 * A link to the mail thread message
 * @member {String} body_url
 */
_BaseMailThreadMessagesAllOf["default"].prototype['body_url'] = undefined;
/**
 * ID of the mail thread
 * @member {Number} mail_thread_id
 */
_BaseMailThreadMessagesAllOf["default"].prototype['mail_thread_id'] = undefined;
/**
 * If the mail message has a draft status then the value is the mail message object as JSON formatted string, otherwise `null`.
 * @member {String} draft
 */
_BaseMailThreadMessagesAllOf["default"].prototype['draft'] = undefined;
/**
 * Whether the mail thread message has a body
 * @member {module:model/NumberBooleanDefault0} has_body_flag
 */
_BaseMailThreadMessagesAllOf["default"].prototype['has_body_flag'] = undefined;
/**
 * Whether the mail thread message is sent
 * @member {module:model/NumberBooleanDefault0} sent_flag
 */
_BaseMailThreadMessagesAllOf["default"].prototype['sent_flag'] = undefined;
/**
 * Whether the mail thread message is sent from Pipedrive
 * @member {module:model/NumberBooleanDefault0} sent_from_pipedrive_flag
 */
_BaseMailThreadMessagesAllOf["default"].prototype['sent_from_pipedrive_flag'] = undefined;
/**
 * The time when the mail message was received or created
 * @member {Date} message_time
 */
_BaseMailThreadMessagesAllOf["default"].prototype['message_time'] = undefined;
/**
 * The time when the mail message was inserted to database
 * @member {Date} add_time
 */
_BaseMailThreadMessagesAllOf["default"].prototype['add_time'] = undefined;
/**
 * The time when the mail message was updated in database received
 * @member {Date} update_time
 */
_BaseMailThreadMessagesAllOf["default"].prototype['update_time'] = undefined;
var _default = BaseMailThreadMessages;
