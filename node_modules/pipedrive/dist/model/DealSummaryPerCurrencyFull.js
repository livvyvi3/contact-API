...
var _DealSummaryPerCurrencyFullCURRENCYID = _interopRequireDefault(require("./DealSummaryPerCurrencyFullCURRENCYID"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var DealSummaryPerCurrencyFull = /*#__PURE__*/function () {
  /**
   ...
   */
  function DealSummaryPerCurrencyFull() {
    (0, _classCallCheck2["default"])(this, DealSummaryPerCurrencyFull);
   ...
   */
  (0, _createClass2["default"])(DealSummaryPerCurrencyFull, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('CURRENCY_ID')) {
          obj['CURRENCY_ID'] = _DealSummaryPerCurrencyFullCURRENCYID["default"].constructFromObject(data['CURRENCY_ID']);
  ...
  return DealSummaryPerCurrencyFull;
}();
/**
...
var _default = DealSummaryPerCurrencyFull;
