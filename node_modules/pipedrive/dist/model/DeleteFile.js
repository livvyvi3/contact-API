...
var _DeleteFileData = _interopRequireDefault(require("./DeleteFileData"));
/**
 * Pipedrive API v1
...
var DeleteFile = /*#__PURE__*/function () {
   ...
   */
  function DeleteFile() {
    (0, _classCallCheck2["default"])(this, DeleteFile);
   ...
   */
  (0, _createClass2["default"])(DeleteFile, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DeleteFileData["default"].constructFromObject(data['data']);
          delete data['data'];
        }
