 ...
 * @version 1.0.0
 */
var BaseUserMeAllOfLanguage = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BaseUserMeAllOfLanguage</code>.
   * The user language details
   * @alias module:model/BaseUserMeAllOfLanguage
   */
  function BaseUserMeAllOfLanguage() {
    (0, _classCallCheck2["default"])(this, BaseUserMeAllOfLanguage);
   ...
   */
  (0, _createClass2["default"])(BaseUserMeAllOfLanguage, null, [{
    key: "initialize",
  ...
  return BaseUserMeAllOfLanguage;
}();
/**
...
var _default = BaseUserMeAllOfLanguage;
