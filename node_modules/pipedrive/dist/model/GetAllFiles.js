...
var _AdditionalDataWithPaginationDetails = _interopRequireDefault(require("./AdditionalDataWithPaginationDetails"));
...
var GetAllFiles = /*#__PURE__*/function () {
  ...
  function GetAllFiles() {
    (0, _classCallCheck2["default"])(this, GetAllFiles);
   ...
   */
  (0, _createClass2["default"])(GetAllFiles, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_FileData["default"]]);
          delete data['data'];
        }
        if (data.hasOwnProperty('additional_data')) {
          obj['additional_data'] = _AdditionalDataWithPaginationDetails["default"].constructFromObject(data['additional_data']);
