 ...
 * @version 1.0.0
 */
var PictureDataPictures = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PictureDataPictures</code>.
   * @alias module:model/PictureDataPictures
   */
  function PictureDataPictures() {
    (0, _classCallCheck2["default"])(this, PictureDataPictures);
   ...
   */
  (0, _createClass2["default"])(PictureDataPictures, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('128')) {
          obj['128'] = _ApiClient["default"].convertToType(data['128'], 'String');
          delete data['128'];
        }
        if (data.hasOwnProperty('512')) {
          obj['512'] = _ApiClient["default"].convertToType(data['512'], 'String');
          delete data['512'];
        }
...
var _default = PictureDataPictures;
