 ...
 * @version 1.0.0
 */
var PostRoleSettingsAllOfData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PostRoleSettingsAllOfData</code>.
   * The response data
   * @alias module:model/PostRoleSettingsAllOfData
   */
  function PostRoleSettingsAllOfData() {
    (0, _classCallCheck2["default"])(this, PostRoleSettingsAllOfData);
   ...
   */
  (0, _createClass2["default"])(PostRoleSettingsAllOfData, null, [{
    key: "initialize",
  ...
  return PostRoleSettingsAllOfData;
}();
/**
 * The ID of the role
 * @member {Number} id
