...
var _DealCountAndActivityInfo = _interopRequireDefault(require("./DealCountAndActivityInfo"));
var _PersonCountAndEmailInfo = _interopRequireDefault(require("./PersonCountAndEmailInfo"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var PersonCountEmailDealAndActivityInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function PersonCountEmailDealAndActivityInfo() {
    (0, _classCallCheck2["default"])(this, PersonCountEmailDealAndActivityInfo);
    _PersonCountAndEmailInfo["default"].initialize(this);
    _DealCountAndActivityInfo["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(PersonCountEmailDealAndActivityInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _PersonCountAndEmailInfo["default"].constructFromObject(data, obj);
        _DealCountAndActivityInfo["default"].constructFromObject(data, obj);
  ...
  return PersonCountEmailDealAndActivityInfo;
}();
/**
 ...
 * @member {Number} email_messages_count
 */
_PersonCountAndEmailInfo["default"].prototype['email_messages_count'] = undefined;
/**
 * The count of activities related to the person
 * @member {Number} activities_count
 */
_PersonCountAndEmailInfo["default"].prototype['activities_count'] = undefined;
/**
 * The count of done activities related to the person
 * @member {Number} done_activities_count
 */
_PersonCountAndEmailInfo["default"].prototype['done_activities_count'] = undefined;
/**
 * The count of undone activities related to the person
 * @member {Number} undone_activities_count
 */
_PersonCountAndEmailInfo["default"].prototype['undone_activities_count'] = undefined;
/**
 * The count of files related to the person
 * @member {Number} files_count
 */
_PersonCountAndEmailInfo["default"].prototype['files_count'] = undefined;
/**
 * The count of notes related to the person
 * @member {Number} notes_count
 */
_PersonCountAndEmailInfo["default"].prototype['notes_count'] = undefined;
/**
 * The count of followers related to the person
 * @member {Number} followers_count
 */
_PersonCountAndEmailInfo["default"].prototype['followers_count'] = undefined;
/**
 * The date and time of the last incoming email associated with the person
 * @member {String} last_incoming_mail_time
 */
_PersonCountAndEmailInfo["default"].prototype['last_incoming_mail_time'] = undefined;
/**
 * The date and time of the last outgoing email associated with the person
 * @member {String} last_outgoing_mail_time
 */
_PersonCountAndEmailInfo["default"].prototype['last_outgoing_mail_time'] = undefined;
// Implement DealCountAndActivityInfo interface:
/**
 * The count of open deals related with the item
 * @member {Number} open_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['open_deals_count'] = undefined;
/**
 * The count of related open deals related with the item
 * @member {Number} related_open_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['related_open_deals_count'] = undefined;
/**
 * The count of closed deals related with the item
 * @member {Number} closed_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['closed_deals_count'] = undefined;
/**
 * The count of related closed deals related with the item
 * @member {Number} related_closed_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['related_closed_deals_count'] = undefined;
/**
 * The count of won deals related with the item
 * @member {Number} won_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['won_deals_count'] = undefined;
/**
 * The count of related won deals related with the item
 * @member {Number} related_won_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['related_won_deals_count'] = undefined;
/**
 * The count of lost deals related with the item
 * @member {Number} lost_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['lost_deals_count'] = undefined;
/**
 * The count of related lost deals related with the item
 * @member {Number} related_lost_deals_count
 */
_DealCountAndActivityInfo["default"].prototype['related_lost_deals_count'] = undefined;
/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */
_DealCountAndActivityInfo["default"].prototype['next_activity_date'] = undefined;
/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */
_DealCountAndActivityInfo["default"].prototype['next_activity_time'] = undefined;
/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */
_DealCountAndActivityInfo["default"].prototype['next_activity_id'] = undefined;
/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */
_DealCountAndActivityInfo["default"].prototype['last_activity_id'] = undefined;
/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */
_DealCountAndActivityInfo["default"].prototype['last_activity_date'] = undefined;
var _default = PersonCountEmailDealAndActivityInfo;
