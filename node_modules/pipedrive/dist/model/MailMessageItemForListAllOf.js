 ...
 * @version 1.0.0
 */
var MailMessageItemForListAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>MailMessageItemForListAllOf</code>.
   * @alias module:model/MailMessageItemForListAllOf
   */
  function MailMessageItemForListAllOf() {
    (0, _classCallCheck2["default"])(this, MailMessageItemForListAllOf);
   ...
   */
  (0, _createClass2["default"])(MailMessageItemForListAllOf, null, [{
    key: "initialize",
  ...
  return MailMessageItemForListAllOf;
}();
/**
...
var _default = MailMessageItemForListAllOf;
