...
var _OrganizationRelationshipWithCalculatedFields = _interopRequireDefault(require("./OrganizationRelationshipWithCalculatedFields"));
var _RelatedOrganizationName = _interopRequireDefault(require("./RelatedOrganizationName"));
 ...
 * @version 1.0.0
 */
var OrganizationRelationshipDetails = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrganizationRelationshipDetails() {
    (0, _classCallCheck2["default"])(this, OrganizationRelationshipDetails);
    _OrganizationRelationshipWithCalculatedFields["default"].initialize(this);
    _RelatedOrganizationName["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(OrganizationRelationshipDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _OrganizationRelationshipWithCalculatedFields["default"].constructFromObject(data, obj);
        _RelatedOrganizationName["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('calculated_type')) {
          obj['calculated_type'] = _ApiClient["default"].convertToType(data['calculated_type'], 'String');
          delete data['calculated_type'];
        }
        if (data.hasOwnProperty('calculated_related_org_id')) {
          obj['calculated_related_org_id'] = _ApiClient["default"].convertToType(data['calculated_related_org_id'], 'Number');
          delete data['calculated_related_org_id'];
        }
        if (data.hasOwnProperty('related_organization_name')) {
          obj['related_organization_name'] = _ApiClient["default"].convertToType(data['related_organization_name'], 'String');
  ...
  return OrganizationRelationshipDetails;
}();
/**
 ...
 * @member {Number} id
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['id'] = undefined;
/**
 * The type of the relationship
 * @member {String} type
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['type'] = undefined;
/**
 * @member {module:model/RelationshipOrganizationInfoItem} rel_owner_org_id
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['rel_owner_org_id'] = undefined;
/**
 * @member {module:model/RelationshipOrganizationInfoItem} rel_linked_org_id
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['rel_linked_org_id'] = undefined;
/**
 * The creation date and time of the relationship
 * @member {String} add_time
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['add_time'] = undefined;
/**
 * The last updated date and time of the relationship
 * @member {String} update_time
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['update_time'] = undefined;
/**
 * Whether the relationship is active or not
 * @member {String} active_flag
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['active_flag'] = undefined;
/**
 * The calculated type of the relationship with the linked organization
 * @member {String} calculated_type
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['calculated_type'] = undefined;
/**
 * The ID of the linked organization
 * @member {Number} calculated_related_org_id
 */
_OrganizationRelationshipWithCalculatedFields["default"].prototype['calculated_related_org_id'] = undefined;
// Implement RelatedOrganizationName interface:
/**
 * The name of the linked organization
 * @member {String} related_organization_name
 */
_RelatedOrganizationName["default"].prototype['related_organization_name'] = undefined;
var _default = OrganizationRelationshipDetails;
