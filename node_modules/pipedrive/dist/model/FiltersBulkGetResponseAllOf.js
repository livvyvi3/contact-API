 ...
 * @version 1.0.0
 */
var FiltersBulkGetResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FiltersBulkGetResponseAllOf</code>.
   * @alias module:model/FiltersBulkGetResponseAllOf
   */
  function FiltersBulkGetResponseAllOf() {
    (0, _classCallCheck2["default"])(this, FiltersBulkGetResponseAllOf);
   ...
   */
  (0, _createClass2["default"])(FiltersBulkGetResponseAllOf, null, [{
    key: "initialize",
  ...
  return FiltersBulkGetResponseAllOf;
}();
/**
...
var _default = FiltersBulkGetResponseAllOf;
