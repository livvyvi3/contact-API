...
var _ProductSearchResponseAllOf = _interopRequireDefault(require("./ProductSearchResponseAllOf"));
var _ProductSearchResponseAllOfData = _interopRequireDefault(require("./ProductSearchResponseAllOfData"));
/**
 * Pipedrive API v1
...
var ProductSearchResponse = /*#__PURE__*/function () {
  ...
  function ProductSearchResponse() {
    (0, _classCallCheck2["default"])(this, ProductSearchResponse);
    _BaseResponse["default"].initialize(this);
    _ProductSearchResponseAllOf["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(ProductSearchResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ProductSearchResponseAllOf["default"].constructFromObject(data, obj);
        if (data.hasOwnProperty('success')) {
          obj['success'] = _ApiClient["default"].convertToType(data['success'], 'Boolean');
          delete data['success'];
        }
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ProductSearchResponseAllOfData["default"].constructFromObject(data['data']);
          delete data['data'];
        }
 ...
 * @member {module:model/ProductSearchResponseAllOfData} data
 */
_ProductSearchResponseAllOf["default"].prototype['data'] = undefined;
/**
 * @member {module:model/ItemSearchAdditionalData} additional_data
 */
_ProductSearchResponseAllOf["default"].prototype['additional_data'] = undefined;
var _default = ProductSearchResponse;
