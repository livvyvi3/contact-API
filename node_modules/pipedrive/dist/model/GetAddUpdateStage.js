 ...
 * @version 1.0.0
 */
var GetAddUpdateStage = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetAddUpdateStage</code>.
   * @alias module:model/GetAddUpdateStage
   */
  function GetAddUpdateStage() {
    (0, _classCallCheck2["default"])(this, GetAddUpdateStage);
   ...
   */
  (0, _createClass2["default"])(GetAddUpdateStage, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _BaseStage["default"].constructFromObject(data['data']);
          delete data['data'];
        }
...
var _default = GetAddUpdateStage;
