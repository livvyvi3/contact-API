...
var _ProductSearchItem = _interopRequireDefault(require("./ProductSearchItem"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var ProductSearchResponseAllOfData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ProductSearchResponseAllOfData</code>.
   * @alias module:model/ProductSearchResponseAllOfData
   */
  function ProductSearchResponseAllOfData() {
    (0, _classCallCheck2["default"])(this, ProductSearchResponseAllOfData);
   ...
   */
  (0, _createClass2["default"])(ProductSearchResponseAllOfData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_ProductSearchItem["default"]]);
          delete data['items'];
        }
  ...
  return ProductSearchResponseAllOfData;
}();
/**
...
var _default = ProductSearchResponseAllOfData;
