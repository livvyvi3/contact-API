 ...
 * @version 1.0.0
 */
var AddPersonPictureRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function AddPersonPictureRequest(file) {
    (0, _classCallCheck2["default"])(this, AddPersonPictureRequest);
   ...
   */
  (0, _createClass2["default"])(AddPersonPictureRequest, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('crop_x')) {
          obj['crop_x'] = _ApiClient["default"].convertToType(data['crop_x'], 'Number');
          delete data['crop_x'];
        }
        if (data.hasOwnProperty('crop_y')) {
          obj['crop_y'] = _ApiClient["default"].convertToType(data['crop_y'], 'Number');
          delete data['crop_y'];
        }
        if (data.hasOwnProperty('crop_width')) {
          obj['crop_width'] = _ApiClient["default"].convertToType(data['crop_width'], 'Number');
          delete data['crop_width'];
        }
        if (data.hasOwnProperty('crop_height')) {
          obj['crop_height'] = _ApiClient["default"].convertToType(data['crop_height'], 'Number');
  ...
  return AddPersonPictureRequest;
}();
/**
...
var _default = AddPersonPictureRequest;
