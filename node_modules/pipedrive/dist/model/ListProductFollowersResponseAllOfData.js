 ...
 * @version 1.0.0
 */
var ListProductFollowersResponseAllOfData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListProductFollowersResponseAllOfData</code>.
   * @alias module:model/ListProductFollowersResponseAllOfData
   */
  function ListProductFollowersResponseAllOfData() {
    (0, _classCallCheck2["default"])(this, ListProductFollowersResponseAllOfData);
   ...
   */
  (0, _createClass2["default"])(ListProductFollowersResponseAllOfData, null, [{
    key: "initialize",
  ...
  return ListProductFollowersResponseAllOfData;
}();
/**
 * The ID of the user
...
var _default = ListProductFollowersResponseAllOfData;
