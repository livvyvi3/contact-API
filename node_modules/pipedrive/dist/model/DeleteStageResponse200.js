...
var _DeleteStageResponse200Data = _interopRequireDefault(require("./DeleteStageResponse200Data"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var DeleteStageResponse200 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DeleteStageResponse200</code>.
   * @alias module:model/DeleteStageResponse200
   */
  function DeleteStageResponse200() {
    (0, _classCallCheck2["default"])(this, DeleteStageResponse200);
   ...
   */
  (0, _createClass2["default"])(DeleteStageResponse200, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DeleteStageResponse200Data["default"].constructFromObject(data['data']);
          delete data['data'];
        }
...
var _default = DeleteStageResponse200;
