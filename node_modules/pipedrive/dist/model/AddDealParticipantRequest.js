 ...
 * @version 1.0.0
 */
var AddDealParticipantRequest = /*#__PURE__*/function () {
  /**
   ...
   */
  function AddDealParticipantRequest(personId) {
    (0, _classCallCheck2["default"])(this, AddDealParticipantRequest);
   ...
   */
  (0, _createClass2["default"])(AddDealParticipantRequest, null, [{
    key: "initialize",
    value: function initialize(obj, personId) {
  ...
  return AddDealParticipantRequest;
}();
/**
...
var _default = AddDealParticipantRequest;
