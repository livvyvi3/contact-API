 ...
 * @version 1.0.0
 */
var GlobalMessageUserData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GlobalMessageUserData</code>.
   * The global message type info
   * @alias module:model/GlobalMessageUserData
   */
  function GlobalMessageUserData() {
    (0, _classCallCheck2["default"])(this, GlobalMessageUserData);
   ...
   */
  (0, _createClass2["default"])(GlobalMessageUserData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('dismissible_flag')) {
          obj['dismissible_flag'] = _ApiClient["default"].convertToType(data['dismissible_flag'], 'Boolean');
...
var _default = GlobalMessageUserData;
