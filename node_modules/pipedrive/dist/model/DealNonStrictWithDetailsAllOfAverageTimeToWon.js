 ...
 * @version 1.0.0
 */
var DealNonStrictWithDetailsAllOfAverageTimeToWon = /*#__PURE__*/function () {
  /**
   ...
   */
  function DealNonStrictWithDetailsAllOfAverageTimeToWon() {
    (0, _classCallCheck2["default"])(this, DealNonStrictWithDetailsAllOfAverageTimeToWon);
   ...
   */
  (0, _createClass2["default"])(DealNonStrictWithDetailsAllOfAverageTimeToWon, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('s')) {
          obj['s'] = _ApiClient["default"].convertToType(data['s'], 'Number');
          delete data['s'];
        }
        if (data.hasOwnProperty('total_seconds')) {
          obj['total_seconds'] = _ApiClient["default"].convertToType(data['total_seconds'], 'Number');
  ...
  return DealNonStrictWithDetailsAllOfAverageTimeToWon;
}();
/**
 * Years
 * @member {Number} y
...
var _default = DealNonStrictWithDetailsAllOfAverageTimeToWon;
