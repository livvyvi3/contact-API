...
var _DeletePipelineResponse200Data = _interopRequireDefault(require("./DeletePipelineResponse200Data"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var DeletePipelineResponse200 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DeletePipelineResponse200</code>.
   * @alias module:model/DeletePipelineResponse200
   */
  function DeletePipelineResponse200() {
    (0, _classCallCheck2["default"])(this, DeletePipelineResponse200);
   ...
   */
  (0, _createClass2["default"])(DeletePipelineResponse200, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DeletePipelineResponse200Data["default"].constructFromObject(data['data']);
          delete data['data'];
        }
...
var _default = DeletePipelineResponse200;
