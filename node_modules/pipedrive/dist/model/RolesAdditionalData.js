...
var _RolesAdditionalDataPagination = _interopRequireDefault(require("./RolesAdditionalDataPagination"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var RolesAdditionalData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RolesAdditionalData</code>.
   * The additional data in the role list
   * @alias module:model/RolesAdditionalData
   */
  function RolesAdditionalData() {
    (0, _classCallCheck2["default"])(this, RolesAdditionalData);
   ...
   */
  (0, _createClass2["default"])(RolesAdditionalData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('pagination')) {
          obj['pagination'] = _RolesAdditionalDataPagination["default"].constructFromObject(data['pagination']);
