 ...
 * @version 1.0.0
 */
var RelatedOrganizationData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RelatedOrganizationData</code>.
   * @alias module:model/RelatedOrganizationData
   */
  function RelatedOrganizationData() {
    (0, _classCallCheck2["default"])(this, RelatedOrganizationData);
   ...
   */
  (0, _createClass2["default"])(RelatedOrganizationData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('ORGANIZATION_ID')) {
          obj['ORGANIZATION_ID'] = _OrganizationDataWithId["default"].constructFromObject(data['ORGANIZATION_ID']);
