...
var _GetLeadSourcesResponse200Data = _interopRequireDefault(require("./GetLeadSourcesResponse200Data"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var GetLeadSourcesResponse200 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLeadSourcesResponse200</code>.
   * @alias module:model/GetLeadSourcesResponse200
   */
  function GetLeadSourcesResponse200() {
    (0, _classCallCheck2["default"])(this, GetLeadSourcesResponse200);
   ...
   */
  (0, _createClass2["default"])(GetLeadSourcesResponse200, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_GetLeadSourcesResponse200Data["default"]]);
          delete data['data'];
        }
...
var _default = GetLeadSourcesResponse200;
