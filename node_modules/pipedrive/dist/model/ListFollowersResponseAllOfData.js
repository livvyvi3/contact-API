 ...
 * @version 1.0.0
 */
var ListFollowersResponseAllOfData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListFollowersResponseAllOfData</code>.
   * @alias module:model/ListFollowersResponseAllOfData
   */
  function ListFollowersResponseAllOfData() {
    (0, _classCallCheck2["default"])(this, ListFollowersResponseAllOfData);
   ...
   */
  (0, _createClass2["default"])(ListFollowersResponseAllOfData, null, [{
    key: "initialize",
  ...
  return ListFollowersResponseAllOfData;
}();
/**
 * The ID of the user
...
var _default = ListFollowersResponseAllOfData;
