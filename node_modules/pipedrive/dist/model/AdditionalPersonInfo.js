...
var _PersonCountEmailDealAndActivityInfo = _interopRequireDefault(require("./PersonCountEmailDealAndActivityInfo"));
var _PersonNameInfoWithOrgAndOwnerId = _interopRequireDefault(require("./PersonNameInfoWithOrgAndOwnerId"));
 ...
 * @version 1.0.0
 */
var AdditionalPersonInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function AdditionalPersonInfo() {
    (0, _classCallCheck2["default"])(this, AdditionalPersonInfo);
    _PersonNameInfoWithOrgAndOwnerId["default"].initialize(this);
    _PersonCountEmailDealAndActivityInfo["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(AdditionalPersonInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _PersonNameInfoWithOrgAndOwnerId["default"].constructFromObject(data, obj);
        _PersonCountEmailDealAndActivityInfo["default"].constructFromObject(data, obj);
 ...
 * @member {module:model/Owner} owner_id
 */
_PersonNameInfoWithOrgAndOwnerId["default"].prototype['owner_id'] = undefined;
/**
 * @member {module:model/RelationshipOrganizationInfoItemWithActiveFlag} org_id
 */
_PersonNameInfoWithOrgAndOwnerId["default"].prototype['org_id'] = undefined;
/**
 * The name of the person
 * @member {String} name
 */
_PersonNameInfoWithOrgAndOwnerId["default"].prototype['name'] = undefined;
/**
 * The first name of the person
 * @member {String} first_name
 */
_PersonNameInfoWithOrgAndOwnerId["default"].prototype['first_name'] = undefined;
/**
 * The last name of the person
 * @member {String} last_name
 */
_PersonNameInfoWithOrgAndOwnerId["default"].prototype['last_name'] = undefined;
// Implement PersonCountEmailDealAndActivityInfo interface:
/**
 * The count of email messages related to the person
 * @member {Number} email_messages_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['email_messages_count'] = undefined;
/**
 * The count of activities related to the person
 * @member {Number} activities_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['activities_count'] = undefined;
/**
 * The count of done activities related to the person
 * @member {Number} done_activities_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['done_activities_count'] = undefined;
/**
 * The count of undone activities related to the person
 * @member {Number} undone_activities_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['undone_activities_count'] = undefined;
/**
 * The count of files related to the person
 * @member {Number} files_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['files_count'] = undefined;
/**
 * The count of notes related to the person
 * @member {Number} notes_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['notes_count'] = undefined;
/**
 * The count of followers related to the person
 * @member {Number} followers_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['followers_count'] = undefined;
/**
 * The date and time of the last incoming email associated with the person
 * @member {String} last_incoming_mail_time
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['last_incoming_mail_time'] = undefined;
/**
 * The date and time of the last outgoing email associated with the person
 * @member {String} last_outgoing_mail_time
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['last_outgoing_mail_time'] = undefined;
/**
 * The count of open deals related with the item
 * @member {Number} open_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['open_deals_count'] = undefined;
/**
 * The count of related open deals related with the item
 * @member {Number} related_open_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['related_open_deals_count'] = undefined;
/**
 * The count of closed deals related with the item
 * @member {Number} closed_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['closed_deals_count'] = undefined;
/**
 * The count of related closed deals related with the item
 * @member {Number} related_closed_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['related_closed_deals_count'] = undefined;
/**
 * The count of won deals related with the item
 * @member {Number} won_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['won_deals_count'] = undefined;
/**
 * The count of related won deals related with the item
 * @member {Number} related_won_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['related_won_deals_count'] = undefined;
/**
 * The count of lost deals related with the item
 * @member {Number} lost_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['lost_deals_count'] = undefined;
/**
 * The count of related lost deals related with the item
 * @member {Number} related_lost_deals_count
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['related_lost_deals_count'] = undefined;
/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['next_activity_date'] = undefined;
/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['next_activity_time'] = undefined;
/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['next_activity_id'] = undefined;
/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['last_activity_id'] = undefined;
/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */
_PersonCountEmailDealAndActivityInfo["default"].prototype['last_activity_date'] = undefined;
var _default = AdditionalPersonInfo;
