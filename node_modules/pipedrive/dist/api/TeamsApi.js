...
var TeamsApi = /*#__PURE__*/function () {
  ...
  */
  function TeamsApi(apiClient) {
    (0, _classCallCheck2["default"])(this, TeamsApi);
   ...
   */
  (0, _createClass2["default"])(TeamsApi, [{
    ...
    value: function addTeamUserWithHttpInfo(id, opts) {
      ...
      return this.apiClient.callApi('/teams/{id}/users', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function deleteTeamUserWithHttpInfo(id, opts) {
      ...
      var accepts = ['application/json'];
      var returnType = _UserIDs["default"];
      return this.apiClient.callApi('/teams/{id}/users', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getTeamUsersWithHttpInfo(id) {
      ...
      var accepts = ['application/json'];
      var returnType = _UserIDs["default"];
      return this.apiClient.callApi('/teams/{id}/users', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function getUserTeamsWithHttpInfo(id, opts) {
      ...
      var accepts = ['application/json'];
      var returnType = _Teams["default"];
      return this.apiClient.callApi('/teams/user/{id}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    ...
    value: function updateTeamWithHttpInfo(id, opts) {
      ...
      var accepts = ['application/json'];
      var returnType = _Team["default"];
      return this.apiClient.callApi('/teams/{id}', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
