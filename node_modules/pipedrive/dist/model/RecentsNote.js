 ...
 * @version 1.0.0
 */
var RecentsNote = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RecentsNote</code>.
   * @alias module:model/RecentsNote
   */
  function RecentsNote() {
    (0, _classCallCheck2["default"])(this, RecentsNote);
   ...
   */
  (0, _createClass2["default"])(RecentsNote, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _BaseNote["default"].constructFromObject(data['data']);
          delete data['data'];
        }
