...
var _DealSummaryPerStagesSTAGEIDCURRENCYID = _interopRequireDefault(require("./DealSummaryPerStagesSTAGEIDCURRENCYID"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var DealSummaryPerStagesSTAGEID = /*#__PURE__*/function () {
  /**
   ...
   */
  function DealSummaryPerStagesSTAGEID() {
    (0, _classCallCheck2["default"])(this, DealSummaryPerStagesSTAGEID);
   ...
   */
  (0, _createClass2["default"])(DealSummaryPerStagesSTAGEID, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('CURRENCY_ID')) {
          obj['CURRENCY_ID'] = _DealSummaryPerStagesSTAGEIDCURRENCYID["default"].constructFromObject(data['CURRENCY_ID']);
  ...
  return DealSummaryPerStagesSTAGEID;
}();
/**
...
var _default = DealSummaryPerStagesSTAGEID;
