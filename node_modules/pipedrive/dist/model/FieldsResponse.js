...
var _FieldsResponseAllOf = _interopRequireDefault(require("./FieldsResponseAllOf"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var FieldsResponse = /*#__PURE__*/function () {
  /**
  ...
  function FieldsResponse() {
    (0, _classCallCheck2["default"])(this, FieldsResponse);
    _BaseResponse["default"].initialize(this);
    _FieldsResponseAllOf["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(FieldsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _FieldsResponseAllOf["default"].constructFromObject(data, obj);
        if (data.hasOwnProperty('success')) {
          obj['success'] = _ApiClient["default"].convertToType(data['success'], 'Boolean');
          delete data['success'];
        }
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_Field["default"]]);
          delete data['data'];
        }
 ...
 * @member {Array.<module:model/Field>} data
 */
_FieldsResponseAllOf["default"].prototype['data'] = undefined;
/**
 * @member {module:model/AdditionalData} additional_data
 */
_FieldsResponseAllOf["default"].prototype['additional_data'] = undefined;
var _default = FieldsResponse;
