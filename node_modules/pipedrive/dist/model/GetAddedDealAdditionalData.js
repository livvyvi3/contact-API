 ...
 * @version 1.0.0
 */
var GetAddedDealAdditionalData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetAddedDealAdditionalData</code>.
   * @alias module:model/GetAddedDealAdditionalData
   */
  function GetAddedDealAdditionalData() {
    (0, _classCallCheck2["default"])(this, GetAddedDealAdditionalData);
   ...
   */
  (0, _createClass2["default"])(GetAddedDealAdditionalData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('matches_filters')) {
          obj['matches_filters'] = _ApiClient["default"].convertToType(data['matches_filters'], ['Number']);
  ...
  return GetAddedDealAdditionalData;
}();
/**
...
var _default = GetAddedDealAdditionalData;
