...
var _RelatedFollowerData = _interopRequireDefault(require("./RelatedFollowerData"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var OrganizationDetailsGetResponseAllOfAdditionalData = /*#__PURE__*/function () {
  /**
   ...
   */
  function OrganizationDetailsGetResponseAllOfAdditionalData() {
    (0, _classCallCheck2["default"])(this, OrganizationDetailsGetResponseAllOfAdditionalData);
   ...
   */
  (0, _createClass2["default"])(OrganizationDetailsGetResponseAllOfAdditionalData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('followers')) {
          obj['followers'] = _RelatedFollowerData["default"].constructFromObject(data['followers']);
          delete data['followers'];
        }
        if (data.hasOwnProperty('dropbox_email')) {
          obj['dropbox_email'] = _ApiClient["default"].convertToType(data['dropbox_email'], 'String');
  ...
  return OrganizationDetailsGetResponseAllOfAdditionalData;
}();
/**
...
var _default = OrganizationDetailsGetResponseAllOfAdditionalData;
