...
var _DeleteActivitiesResponse200Data = _interopRequireDefault(require("./DeleteActivitiesResponse200Data"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var DeleteActivitiesResponse200 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DeleteActivitiesResponse200</code>.
   * @alias module:model/DeleteActivitiesResponse200
   */
  function DeleteActivitiesResponse200() {
    (0, _classCallCheck2["default"])(this, DeleteActivitiesResponse200);
   ...
   */
  (0, _createClass2["default"])(DeleteActivitiesResponse200, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DeleteActivitiesResponse200Data["default"].constructFromObject(data['data']);
          delete data['data'];
        }
...
var _default = DeleteActivitiesResponse200;
