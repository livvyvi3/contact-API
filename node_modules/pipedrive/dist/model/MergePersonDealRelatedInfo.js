...
var _DealParticipantCountInfo = _interopRequireDefault(require("./DealParticipantCountInfo"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var MergePersonDealRelatedInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function MergePersonDealRelatedInfo() {
    (0, _classCallCheck2["default"])(this, MergePersonDealRelatedInfo);
    _DealCountAndActivityInfo["default"].initialize(this);
    _DealParticipantCountInfo["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(MergePersonDealRelatedInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _DealParticipantCountInfo["default"].constructFromObject(data, obj);
  ...
  return MergePersonDealRelatedInfo;
}();
/**
 ...
 * @member {Number} participant_open_deals_count
 */
_DealParticipantCountInfo["default"].prototype['participant_open_deals_count'] = undefined;
/**
 * The count of closed participant deals related with the item
 * @member {Number} participant_closed_deals_count
 */
_DealParticipantCountInfo["default"].prototype['participant_closed_deals_count'] = undefined;
var _default = MergePersonDealRelatedInfo;
