...
var _DeleteDealData = _interopRequireDefault(require("./DeleteDealData"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var DeleteDeal = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DeleteDeal</code>.
   * @alias module:model/DeleteDeal
   */
  function DeleteDeal() {
    (0, _classCallCheck2["default"])(this, DeleteDeal);
   ...
   */
  (0, _createClass2["default"])(DeleteDeal, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _DeleteDealData["default"].constructFromObject(data['data']);
          delete data['data'];
        }
