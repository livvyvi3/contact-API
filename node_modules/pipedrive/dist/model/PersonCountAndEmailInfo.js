...
var _EmailInfo = _interopRequireDefault(require("./EmailInfo"));
var _PersonCountInfo = _interopRequireDefault(require("./PersonCountInfo"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var PersonCountAndEmailInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function PersonCountAndEmailInfo() {
    (0, _classCallCheck2["default"])(this, PersonCountAndEmailInfo);
    _PersonCountInfo["default"].initialize(this);
    _EmailInfo["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(PersonCountAndEmailInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _PersonCountInfo["default"].constructFromObject(data, obj);
        _EmailInfo["default"].constructFromObject(data, obj);
  ...
  return PersonCountAndEmailInfo;
}();
/**
 ...
 * @member {Number} email_messages_count
 */
_PersonCountInfo["default"].prototype['email_messages_count'] = undefined;
/**
 * The count of activities related to the person
 * @member {Number} activities_count
 */
_PersonCountInfo["default"].prototype['activities_count'] = undefined;
/**
 * The count of done activities related to the person
 * @member {Number} done_activities_count
 */
_PersonCountInfo["default"].prototype['done_activities_count'] = undefined;
/**
 * The count of undone activities related to the person
 * @member {Number} undone_activities_count
 */
_PersonCountInfo["default"].prototype['undone_activities_count'] = undefined;
/**
 * The count of files related to the person
 * @member {Number} files_count
 */
_PersonCountInfo["default"].prototype['files_count'] = undefined;
/**
 * The count of notes related to the person
 * @member {Number} notes_count
 */
_PersonCountInfo["default"].prototype['notes_count'] = undefined;
/**
 * The count of followers related to the person
 * @member {Number} followers_count
 */
_PersonCountInfo["default"].prototype['followers_count'] = undefined;
// Implement EmailInfo interface:
/**
 * The date and time of the last incoming email associated with the person
 * @member {String} last_incoming_mail_time
 */
_EmailInfo["default"].prototype['last_incoming_mail_time'] = undefined;
/**
 * The date and time of the last outgoing email associated with the person
 * @member {String} last_outgoing_mail_time
 */
_EmailInfo["default"].prototype['last_outgoing_mail_time'] = undefined;
var _default = PersonCountAndEmailInfo;
