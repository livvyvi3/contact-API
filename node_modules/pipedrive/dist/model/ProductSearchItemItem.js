...
var _ProductSearchItemItemOwner = _interopRequireDefault(require("./ProductSearchItemItemOwner"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var ProductSearchItemItem = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ProductSearchItemItem</code>.
   * @alias module:model/ProductSearchItemItem
   */
  function ProductSearchItemItem() {
    (0, _classCallCheck2["default"])(this, ProductSearchItemItem);
   ...
   */
  (0, _createClass2["default"])(ProductSearchItemItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('owner')) {
          obj['owner'] = _ProductSearchItemItemOwner["default"].constructFromObject(data['owner']);
          delete data['owner'];
        }
...
var _default = ProductSearchItemItem;
