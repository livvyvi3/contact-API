 ...
 * @version 1.0.0
 */
var OrganizationFollowerPostResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>OrganizationFollowerPostResponse</code>.
   * @alias module:model/OrganizationFollowerPostResponse
   */
  function OrganizationFollowerPostResponse() {
    (0, _classCallCheck2["default"])(this, OrganizationFollowerPostResponse);
   ...
   */
  (0, _createClass2["default"])(OrganizationFollowerPostResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _OrganizationFollowerItem["default"].constructFromObject(data['data']);
          delete data['data'];
        }
  ...
  return OrganizationFollowerPostResponse;
}();
/**
...
var _default = OrganizationFollowerPostResponse;
