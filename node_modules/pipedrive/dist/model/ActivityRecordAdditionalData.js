 ...
 * @version 1.0.0
 */
var ActivityRecordAdditionalData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ActivityRecordAdditionalData</code>.
   * @alias module:model/ActivityRecordAdditionalData
   */
  function ActivityRecordAdditionalData() {
    (0, _classCallCheck2["default"])(this, ActivityRecordAdditionalData);
   ...
   */
  (0, _createClass2["default"])(ActivityRecordAdditionalData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('updates_story_id')) {
          obj['updates_story_id'] = _ApiClient["default"].convertToType(data['updates_story_id'], 'Number');
  ...
  return ActivityRecordAdditionalData;
}();
/**
...
var _default = ActivityRecordAdditionalData;
